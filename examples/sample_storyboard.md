...
| Step 2A | 10s | Source document left, customer and distributor suggestions right | The system suggests the customer and distributor with confidence scores. |
| Step 2B | 10s | Product table with quantity and mapping focus | Then verify products and quantities. |
| Step 3 | 6s | Download Excel button spotlight | Step three: download the final Excel. |
| Impact | 14s | KPI cards animate in | The result is fewer clicks, fewer errors, faster preparation, and a clear audit trail. |
